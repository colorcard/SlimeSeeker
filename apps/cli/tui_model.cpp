...
std::string_view localized_text(Language language, TextKey key) {
    static constexpr std::string_view en[] = {
        ...
        "Search mode", "Chunk density", "Biome score", "Spawn feet Y", "Player feet Y",
        ...
        "Re-scores every density match using the selected Minecraft version, then finds an AFK point.",
        ...
        "Searching and scoring selected-version biomes", "AFK candidates", "Cancel the search and quit?",
    ...
    static constexpr std::string_view zh[] = {
        ...
        "区块密度", "群系评分", "生成脚部 Y", "玩家脚部 Y", "请选择有效搜索模式",
        ...
        "按所选 Minecraft 版本的群系重评分全部密度命中，再寻找挂机点。",
