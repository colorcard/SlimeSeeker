...
ss_status search_cpu_impl(const ss_search_params_v1 &params, const ss_search_options_v1 &options,
                          const ss_callbacks_v1 &callbacks) {
    ss_backend selected{};
    BuildMapFn build_map = select_map_backend(options.backend, selected);
